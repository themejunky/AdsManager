...
public class MainActivity extends AppCompatActivity implements AdsListenerManager.ListenerAds, View.OnClickListener, ListenerContract.AdsInterstitialListener, ListenerContract.NoAdsLoaded {
    ...
    private ManagerInterstitial managerInterstitialAds;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        managerInterstitialAds = ManagerInterstitial.getInstance(this,"InfoAds");
        managerInterstitialAds.initAdmob("ca-app-pub-5322508131338449/6935033151");
